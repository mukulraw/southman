...
public class StatusActivity6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (sta.equals("success"))
        {
            ...
            Call<onlinePayBean> call = cr.freePay(id , pid , SharePreferenceUtils.getInstance().getString("userid"));
        ...
        rate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Dialog dialog = new Dialog(StatusActivity6.this);
                ...
                submit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (rr > 0)
                        {
                            ...
                            call.enqueue(new Callback<scratchCardBean>() {
                                ...
                                public void onResponse(Call<scratchCardBean> call, Response<scratchCardBean> response) {
                                    ...
                                    dialog.dismiss();
                                    Toast.makeText(StatusActivity6.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                        ...
                        {
                            Toast.makeText(StatusActivity6.this, "Please add a rating", Toast.LENGTH_SHORT).show();
                        }
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Instacapture.INSTANCE.capture(StatusActivity6.this , new SimpleScreenCapturingListener() {
                    @Override
        ...
        order.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(StatusActivity6.this , OrderDetails2.class);
